<div id="log-modal" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700 border-white border">
            ...
            <div class="p-4 md:p-5">
                <form class="space-y-4" action="">
                    <div>
                        <label for="l-email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Your
                            email</label>
                        <input autocomplete="off" type="email" id="l-email" name="l-email"
                    ...
                    <div>
                        <label for="l-pass" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Your
                            password</label>
                        <input autocomplete="new-password" type="password" id="l-pass" name="l-pass" placeholder="••••••••"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:outline-none focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                            required>
                    </div>
                    <div class="flex justify-left mx-1">
                        <a href="info.php?t=contact"
