        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700 border border-white">
            ...
            <div class="p-4 md:p-5">
                <form class="space-y-4" action="partials/_s-handler.php" method="post">
                    ...
                    <div>
                        <label for="s-email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Your
                            email</label>
                        <input type="email" autocomplete="off" id="s-email" name="s-email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg  focus:outline-none focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                    ...
                    <button type="submit"
                        class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Create your account</button>
                    <!-- <div class="text-sm font-medium text-gray-500 dark:text-gray-300 mx-1">
                        Already registered? <button data-modal-target="log-modal" data-modal-toggle="log-modal"
                            data-modal-hide="sign-modal" class="text-blue-700 hover:underline dark:text-blue-500">Log
                            in</button>
                    </div> -->
                </form>
            </div>
